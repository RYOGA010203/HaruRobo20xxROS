...
private:
    ...
    /* korejadamemitai  by T.RYOGA 2021_12_13
    boost::asio::strand *_read_strand;
    boost::asio::strand *_write_strand;
    */

    boost::asio::io_service::strand *_read_strand;
...
UsbCanNode::UsbCanNode(void)
{
    ...
    */
    ...
    this->_read_strand = new boost::asio::io_service::strand(*_io);
    this->_write_strand = new boost::asio::io_service::strand(*_io);
