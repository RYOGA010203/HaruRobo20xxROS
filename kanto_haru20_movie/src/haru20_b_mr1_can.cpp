...
private:
    ...
    static constexpr uint16_t id_ft_0_motor_cmd         = 0x500;
    ...
    static constexpr uint16_t id_ft_1_motor_cmd         = 0x4e8;
    ...
    static constexpr uint16_t id_th_motor_cmd           = 0x100;
    ...
    static constexpr uint16_t id_pc_motor_cmd           = 0x104;
